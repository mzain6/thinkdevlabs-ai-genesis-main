      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 animate-slide-up">
          <h2 className="text-3xl font-bold mb-4">
            Trusted by <span className="bg-gradient-primary bg-clip-text text-transparent">200+ Companies</span> Globally
          </h2>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center space-x-4 bg-gradient-card rounded-full px-6 py-3 border border-border/20">
            ...
            <span className="text-sm font-medium text-foreground/80">From 1000+ successful AI implementations</span>
          </div>
        </div>
      </div>
    </section>
