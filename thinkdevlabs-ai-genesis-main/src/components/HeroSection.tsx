        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-scale-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="relative bg-gradient-card rounded-3xl p-8 shadow-3d border border-border/20">
              ...
              <div className="absolute -bottom-4 -left-4 bg-accent text-accent-foreground px-4 py-2 rounded-full text-sm font-semibold shadow-glow animate-float" style={{ animationDelay: '1s' }}>
                Smart AI
              </div>
            </div>
          </div>
